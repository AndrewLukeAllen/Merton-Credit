...
# company = Company("0000037996")  # Ford
...
#         for filing in filings:
#             try:
#                 # Try importing the XBRL data
#                 xbrl = filing.xbrl()

#                 if xbrl is not None:
#                     found_xbrl = True
#                     print(f"XBRL found: {filing.accession_no}")
            
#             except Exception as e:
#                 pass

#         if found_xbrl:
#             print(f"RESULT: {year} has XBRL")
#         else:
#             print(f"RESULT: {year} does NOT have XBRL")

#     except Exception as e:
#         print(f"Could not retrieve filings for {year}: {e}")